...
public class DiceComparator implements Comparator<Dice> {
     ...
     *
     * @param d1 the first dice object to be compared.
     * @param d2 the second dice object to be compared.
     ...
     */
    @Override
    public int compare(Dice d1, Dice d2) throws NullPointerException, ClassCastException {
